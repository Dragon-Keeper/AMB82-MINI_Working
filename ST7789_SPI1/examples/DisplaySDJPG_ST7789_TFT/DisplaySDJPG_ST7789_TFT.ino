/*
 ...
 This sketch shows the example of displaying jpg image from micro SD card on ST7789 TFT display module using SPI1 bus.

 Example guide:
 https://ameba-doc-arduino-sdk.readthedocs-hosted.com/en/latest/ameba_pro2/amb82-mini/Example_Guides/SPI/Display%20SD%20JPG%20ST7789%20TFT.html

*/

#include "SPI.h"
#include "AmebaST7789_DMA_SPI1.h"   // 使用SPI1 DMA版本的ST7789库
...
#define TFT_RESET 5
#define TFT_DC    4
#define TFT_CS    SPI1_SS           // 使用SPI1总线片选引脚

#define ST7789_SPI_FREQUENCY 25000000   // 25 MHz (SPI1总线频率)

AmebaST7789_DMA_SPI1 tft = AmebaST7789_DMA_SPI1(TFT_CS, TFT_DC, TFT_RESET);
...
void setup()
{
    ...
    Serial.println("TFT ST7789 SPI1 DMA - 自动播放 Image_X.jpg 照片");
